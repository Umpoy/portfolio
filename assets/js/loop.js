    ...
    if ($('.slideshow').length > 0) {
        $.supersized({
            ...
            slides: [               // Slideshow Images
                { image: 'assets/img/sliders/slider1.jpg', title: '<div class="hero-text"><h2 class="hero-heading">Chris Kim</h2><p class="slide1">Front-End Web Developer</p></br><p>(HTML5, CSS3, Javascript)</p></div>', thumb: '', url: '' },
